...
import com.example.ambulancefinder.customerui.OtpActivity;
...
public class DriverOtpActivity extends AppCompatActivity {
        ...
        sendotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (phone.trim().length() == 10) {
                    ...
                    Toast.makeText(DriverOtpActivity.this, "Enter Valid PhoneNumber", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
   ...
   /* private void verifyCode(String code){
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(new Intent(DriverOtpActivity.this, DriverHomeActivity.class));
                            finish();
                            Toast.makeText(DriverOtpActivity.this,"Verification Successful", Toast.LENGTH_SHORT).show();
                        } else {
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                // The verification code entered was invalid
                                Toast.makeText(DriverOtpActivity.this,"Verification Failed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
    ...
    private void showDialog() {
        ...
        final EditText edittextCode = new EditText(DriverOtpActivity.this);
